...
//7
function getProductInfo(product: [string, number]): string {
...
formatUserInput(12434); // "User said 12434"
//@ts-expect-error
...
// 9
type UserID = number;
type FetchedUser = { id: UserID; name: string };
function fetchUserData(id: UserID): FetchedUser {
...
function getWidth(rectangle: Rect): number {
...
//11
type Response = [number, string]; // Tuple
